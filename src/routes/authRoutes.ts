...
router.post(
  "/forgot-password",
  rateLimitConfig.forgetPassword,
  forgetPasswordControlled.forgotPassword
);

router.post(
  "/reset-password",
  rateLimitConfig.forgetPassword,
  forgetPasswordControlled.resetPassword
);

router.post(
  "/reset-password/new-otp",
  rateLimitConfig.forgetPassword,
  forgetPasswordControlled.resendOtpForForgetPassowrd
);
